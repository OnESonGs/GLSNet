...
def train_lsnet(m, margin, db_value, channel_name):
...
if __name__ == "__main__":
    train_lsnet(0, 0, 40, 'ChB')
    train_lsnet(0, 0, 30, 'ChB')
    train_lsnet(0, 0, 20, 'ChB')
    train_lsnet(0, 0, 10, 'ChB')
    train_lsnet(0, 0, 0, 'ChB')

    train_lsnet(0, 0, 40, 'ChD')
    train_lsnet(0, 0, 30, 'ChD')
    train_lsnet(0, 0, 20, 'ChD')
    train_lsnet(0, 0, 10, 'ChD')
    train_lsnet(0, 0, 0, 'ChD')